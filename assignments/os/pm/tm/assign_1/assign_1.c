...
/*
 * Write a program to create a child process using fork() system call and
 ...
 *
 * Both parent and child get a copy of data(local, global and heap)
 * with same virtual adrress space (different instances)
 * mapped to seperate physical address spaces which when modified
 * in one process' context will not affect the data in
